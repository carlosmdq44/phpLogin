...
<?php if(auth()->guard()->check()): ?>
    <p class="mt-5 d-flex justify-content-center">Bienvenido <?php echo e(auth()->user()->name ?? auth()->user()->username); ?>, estas autenticado a la pagina</p>
<?php endif; ?>
<head>
        ...
        <v-simple-table class="mt-5">
            <template v-slot:default>
                ...
                <?php $__currentLoopData = $articulos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $articulo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                    <td class="justify-content-center"><?php echo e($articulo ['id']); ?></td>
                    <td class="justify-content-center"><?php echo e($articulo ['descripcion']); ?></td>
                    <td class="justify-content-center"><?php echo e($articulo ['precio']); ?></td>
                    <td class="justify-content-center"><?php echo e($articulo ['stock']); ?></td> 
                    <td>
...
<?php echo $__env->make('layouts.app-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\carlo\OneDrive\Escritorio\php\loginLaravel\resources\views/home/index.blade.php ENDPATH**/ ?>